...
const Hero = () => {
    return (
        <div className='h-[50vh] w-[100%] lg:py-0 bg-[#E6E6E6]  ' >
            <div className='bg-[url("../assests/Img/salebanner.png")]  bg-no-repeat bg-cover bg-[center] h-full w-full' >
                <Wrapper>
                    <div className='justify-between px-4 md:items-center md:flex xl:px-0 h-full'>
                        <div className='flex flex-col h-full justify-center gap-10' >
                            <p className=' text-2xl mdtext-5xl font-semibold' >Summer Sale</p>
